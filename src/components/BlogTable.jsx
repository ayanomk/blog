...
function BlogTable({tableData, setTableData}) {
    ...
    const handleHeadChange = (val, idx) => {        
        const newHeader = [...tableData.content.header];
        newHeader[idx] = val;
        const newData = {
            ...tableData,
            content: {
    ...
    const handleBodyChange = (val, rIdx, cIdx) => {
        const newRowsData = [...tableData.content.rows];
    ...
    const handleDeleteRow = (rIdx) => {
        const rowsData = [...tableData.content.rows];
